...
// Approach Used- Commom Elements means the elements that are common to both th arrays.
...
int main() 
{
    ...
    int intersectionSize = findcommon(arr1, size1, arr2, size2, result);                  // function calling
